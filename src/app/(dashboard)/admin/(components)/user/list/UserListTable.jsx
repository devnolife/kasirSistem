      ...
      columnHelper.accessor('fullName', {
        ...
        columnHelper.accessor('role', {
          ...
          cell: ({ row }) => {
            ...
            const roleObj = userRoleObj[role] || { icon: 'tabler-alert-circle', color: 'error' };

            return (
              <div className='flex items-center gap-2'>
                <Icon
                  className={roleObj.icon}
                  sx={{ color: `var(--mui-palette-${roleObj.color}-main)` }}
                />
      ...
      columnHelper.accessor('action', {
        ...
        cell: () => (
          <div className='flex items-center'>
            ...
            <IconButton>
              <Link href='/admin/user/view' className='flex'>
